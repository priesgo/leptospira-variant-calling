...
echo "Filtering samtools variants ..."
echo
...
echo
echo "java -jar $GATK -T VariantFiltration -R $REFERENCE_LOCAL -V $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.raw_snps.vcf --filterExpression \"QUAL < 17\" --filterName \"QUAL\" --filterExpression \"DP < 3\" --filterName \"DP\" -o $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.filtered_snps.vcf"
java -jar $GATK -T VariantFiltration -R $REFERENCE_LOCAL -V $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.raw_snps.vcf --filterExpression "QUAL < 17" --filterName "QUAL" --filterExpression "DP < 3" --filterName "DP" -o $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.filtered_snps.vcf
echo
...
echo
echo "java -jar $GATK -T VariantFiltration -R $REFERENCE_LOCAL -V $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.raw_indels.vcf --filterExpression \"QUAL < 50\" --filterName \"QUAL\" --filterExpression \"DP < 3\" --filterName \"DP\" -o $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.filtered_indels.vcf"
java -jar $GATK -T VariantFiltration -R $REFERENCE_LOCAL -V $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.raw_indels.vcf --filterExpression "QUAL < 50" --filterName "QUAL" --filterExpression "DP < 3" --filterName "DP" -o $OUTPUT_DIR_LOCAL/$PREFIX_LOCAL.filtered_indels.vcf
echo
